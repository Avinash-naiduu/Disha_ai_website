...
const Terms = () => {
    return (
        <div className="container my-5 terms-container">
            <p className="texprimary">Your Agreement</p>
            <h1 className="terms-title">Terms & Conditions</h1>
            <p className="terms-paragraph">
                These Terms & Conditions (“Terms”) of (a) use of our website www.dishaai.com (“Website”), our applications
                (“Application”) or any products or services in connection with the Application, Website/products (“Services”)
                or (b) any modes of registrations or usage of products, including through SD cards, tablets or other
                storage/transmitting devices are between DISHAAI Edutech Solutions Private Limited (“Company/We/Us/Our”) and its
                users (“User/You/Your”).
            </p>
            <p className="terms-paragraph">
            These Terms constitute an electronic record in accordance with the provisions of the Information Technology Act, 2000 and the Information Technology (Intermediaries guidelines) Rules, 2021 thereunder, as amended from time to time.
            </p>
            <p className="terms-paragraph">
            ...
            <p className="terms-paragraph">
            Use the Services for purposes that are not permitted by: (i) these Terms; and (ii) any applicable law, regulation or generally accepted practices or guidelines in the relevant jurisdiction; 
            </p>
            <p className="terms-paragraph">
            ...
            <p className="terms-paragraph">
            Subscription to the Application or usage of our Services/Website/products does not in any manner guarantee admission to any educational institutions or passing of any exams or achievement of any specified percentage of marks in any examinations.
            </p>
            <p className="terms-paragraph">
            ...
            <p className="terms-paragraph">
            You acknowledge that the Company is not the manufacturer of the instrument/medium/hardware and hence, any defect relating to the same shall be reported to the manufacturer whose details shall be specifed on the packaging and the Company shall not be in any manner responsible for the same. The Company does not provide any guarantee or warranty relating to the instrument/medium/hardware.
            </p>
            <p className="terms-paragraph">
            ...
            <p className="terms-paragraph">
            <strong>DISCLAIMER:</strong> THIS WEBSITE, THE APPLICATION AND THE SERVICES ARE PROVIDED ON AN "AS IS" BASIS WITH ALL FAULTS AND WITHOUT ANY WARRANTY OF ANY KIND. THE COMPANY HEREBY DISCLAIMS ALL WARRANTIES AND CONDITIONS WITH REGARD TO THE WEBSITE, APPLICATION/PRODUCTS AND THE SERVICES, INCLUDING WITHOUT LIMITATION, ALL IMPLIED WARRANTIES AND CONDITIONS OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, ACCURACY, TIMELINESS. PERFORMANCE, COMPLETENESS, SUITABILITY AND NON-INFRINGEMENT. ADDITIONALLY, THE COMPANY SHALL NOT BE LIABLE FOR ANY DAMAGES ARISING OUT OF OR IN CONNECTION WITH THE USE OR PERFORMANCE OF THIS SITE, OR THE APPLICATION OR THE SERVICES. YOUR USE OF ANY INFORMATION OR MATERIALS ON THIS WEBSITE/APPLICATION/SERVICES/PRODUCTS IS ENTIRELY AT YOUR OWN RISK, FOR WHICH WE SHALL NOT BE LIABLE. IT SHALL BE YOUR OWN RESPONSIBILITY TO ENSURE THAT SERVICES PROVIDED BY US MEET YOUR SPECIFIC REQUIREMENTS.
            </p>
            <h2 className="headingg">
            General Provisions:
            </h2>
            <p className="terms-paragraph">
            <strong> Notice:</strong> All notices served by the Company shall be provided via email to Your account or as a general notification on the Application. Any notice to be provided to the Company should be sent to support@dishaai.com.
            </p>
            <p className="terms-paragraph">
            <strong>Entire Agreement:</strong> The Terms, along with the Privacy Policy, and any other guidelines made applicable to the Application from time to time, constitute the entire agreement between the Company and You with respect to Your access to or use of the Application, Website and the Services thereof.
            </p>
            <p className="terms-paragraph">
            <strong>Assignment:</strong> You cannot assign or otherwise transfer Your obligations under the Terms, or any right granted hereunder to any third party. The Company's rights under the Terms are freely transferable by the Company to any third parties without the requirement of seeking Your consent.
            </p>
            <p className="terms-paragraph">
            ...
            <p className="terms-paragraph">
            <strong>Waiver:</strong> Any failure by the Company to enforce or exercise any provision of the Terms, or any related right, shall not constitute a waiver by the Company of that provision or right.
            </p>
            <p className="terms-paragraph">
            <strong>Relationship:</strong> You acknowledge that Your participation on the Application, does not make You an employee or agency or partnership or joint venture or franchise of the Company.
            </p>
            <p className="terms-paragraph">
