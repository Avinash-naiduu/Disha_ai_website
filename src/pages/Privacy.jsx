...
const Privacy = () => {
    return (
        <div className="container my-5 terms-container">
            ...
            We value your trust. In order to respect that trust, <b>DISHAAI</b> adheres to ethical standards in gathering, using, and safeguarding any information you provide.
            </p>
            <p className="terms-paragraph">
            DISHAAI Edutech Solutions Private Limited (operating under the brand name DISHAAI), is a leading edutech solutions company in India, for assess, track and guide students in an holistic manner to achieve their dreams and translate their passion into a successful career.
            </p>
            <p className="terms-paragraph">
            This privacy policy governs your use of the application ' DISHAAI’ - The App' ('Application'), www. dishaai.com ('Website') and the other associated applications, products, websites and services managed by the Company.
            </p>
            <p className="terms-paragraph">
            Please read this privacy policy ('Policy') carefully before using the Application, Website, our services and products, along with the Terms of Use ('ToU') provided on the Application and the Website. Your use of the Website, Application, or  services  in connection with the Application,  Website or products ('Services'), or registrations with us through any  modes or usage of any products including through SD cards, tablets or other storage/transmitting device shall signify your acceptance of this Policy and your agreement to be legally bound by the same.
            </p>
            <p className="terms-paragraph">
